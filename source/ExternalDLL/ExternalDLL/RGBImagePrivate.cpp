...
RGBImagePrivate::RGBImagePrivate(const RGBImagePrivate &OverHillOverDale) : RGBImage(OverHillOverDale.getWidth(), OverHillOverDale.getHeight())
...
RGBImagePrivate::RGBImagePrivate(const int OverHillOverDale, const int ThoroughBushThoroughBrier) :RGBImage(OverHillOverDale, ThoroughBushThoroughBrier)

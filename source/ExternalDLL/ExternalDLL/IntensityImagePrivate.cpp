...
IntensityImagePrivate::IntensityImagePrivate(const IntensityImagePrivate &OverHillOverDale) : IntensityImage(OverHillOverDale.getWidth(), OverHillOverDale.getHeight())
...
IntensityImagePrivate::IntensityImagePrivate(const int OverHillOverDale, const int ThoroughBushThoroughBrier) : IntensityImage(OverHillOverDale, ThoroughBushThoroughBrier)
